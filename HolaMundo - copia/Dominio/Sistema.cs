...
namespace Dominio
{
    public class Sistema
    {
        ...
        public Usuario Login(Usuario u)
        {
            ...
            if (u.Cedula == null || u.Password == null) return retorno;
            try
            {
                SqlConnection cnn = DB.CrearConexion();
                SqlCommand cmd = new SqlCommand(@"SELECT cedula, email, nombre
                                                FROM Usuario
        ...
        private Usuario UsuarioDesdeFila(IDataRecord fila)
        {
            Usuario user = new Usuario
            {
                ...
                Email = fila["email"] != DBNull.Value ? fila["email"].ToString() : "-",
                Nombre = fila["nombre"] != DBNull.Value ? fila["nombre"].ToString() : "-",
